...
import { LayoutDashboard, MessageSquare, Wrench, BarChart3, Shield, ShieldAlert, Settings, Flame, Store, Radio, Users, Brain, Mail, Database, Key, Webhook, CalendarDays, AudioLines, Layers, Video, Activity, Menu, X, ChevronsLeft, ChevronsRight } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/security', i18nKey: 'nav.security', icon: ShieldAlert },
